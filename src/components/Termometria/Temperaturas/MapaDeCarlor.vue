...
export default {
  ...
  watch:{
    pendulos(newValue){
      ...
      // // this.heatmapInstance._renderer.ctx.canvas.minHeight = parseInt(this.boxStyle.height)  
      // // this.heatmapInstance._renderer.ctx.canvas.minWidth = parseInt(this.boxStyle.width)
